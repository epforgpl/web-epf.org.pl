...
<?php endif; ?>
    ...
    <div class="container" id="container_tabs">
        <div id="horizontalTab">
            <ul>
                ...
                <?php if (get_field('practical_info')) {
                    echo '<li><a href="#practical_info">' . __('Practical Information') . '</a></li>';
                } ?>
		...
		<?php if (get_field('Travel_Granty_dla_NGO')) {
            ...
            <div id="tabs_content">
                <?php if (get_field('o_evencie')) {
                    echo '<div id="o_evencie" style="text-align: justify; text-justify: inter-word;"><h2>' . __('O wydarzeniu') . '</h2>';
                    the_field('o_evencie');
                    echo '</div>';
                } ?>
                
                <?php if (get_field('visegrad')) {
                    echo '<div id="visegrad" style="text-align: justify; text-justify: inter-word;"><h2>' . __('Visegrad Project') . '</h2>';
                    the_field('visegrad');
                    echo '</div>';
                } ?>
                
                <?php if (get_field('practical_info')) {
                    echo '<div id="practical_info" style="text-align: justify; text-justify: inter-word;"><h2>' . __('Practical Information') . '</h2>';
    ...
    <div id="event_footer">
		...
		<?php if( $post_objects = get_field('3_polecane_eventy') ) { ?>
